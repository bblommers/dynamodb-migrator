...
# Adopted/adapted from https://gist.github.com/thehesiod/2e4094a1db1190f7e122e7043f1973a0
class MotoService:
    ...
    def __init__(self, service_name: str, port: int = None):
        ...
        self._server: werkzeug.serving.ThreadedWSGIServer = None
    ...
    def _server_entry(self):
        service_name = 'dynamodb2' if self._service_name == 'dynamodb' else self._service_name
        self._main_app = moto.server.DomainDispatcherApplication(moto.server.create_backend_app,
